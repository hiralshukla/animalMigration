...
\033[39;97H                             -+*++***+:  ''')
    ...
    print("\033[23;140H \t12:  608242-718915")
...
\033[40;55H         |/               `^ .''')
    ...
    while True:
        ...
        if choice == "docs":
            file_path = r"data/NWSD/fieldlist.pdf"
        ...
        if choice == "pydocs":
            txt_files = [
                r"pydocumentation.txt",
                r"map_generator_11.txt"
            ]
        ...
        if choice.isdigit():
            if int(choice) == 12:
                file_path = r"data\NWSD\combined_heatmap_with_bird_info.html"
                file_path = os.path.abspath(file_path)
                webbrowser.open('file://' + file_path)
                print("\033[25;140H" + " " * 40)
                print("\a")
            ...
            if int(choice) == 11:
                file_path = r"data\NWSD\final11.html"
                file_path = os.path.abspath(file_path)
                webbrowser.open('file://' + file_path)
                print("\033[25;140H" + " " * 40)
                print("\a")
            ...
            if int(choice) == 10:
                file_path = r"data\NWSD\final10.html"
                file_path = os.path.abspath(file_path)
                webbrowser.open('file://' + file_path)
                print("\033[25;140H" + " " * 40)
                print("\a")
            ...
            if int(choice) == 9:
                file_path = r"data\NWSD\final9.html"
                file_path = os.path.abspath(file_path)
                webbrowser.open('file://' + file_path)
                print("\033[25;140H" + " " * 40)
                print("\a")
            ...
            if int(choice) == 8:
                file_path = r"data\NWSD\final8.html"
                file_path = os.path.abspath(file_path)
                webbrowser.open('file://' + file_path)
                print("\033[25;140H" + " " * 40)
                print("\a")
            ...
            if int(choice) == 7:
                file_path = r"data\NWSD\final7.html"
                file_path = os.path.abspath(file_path)
                webbrowser.open('file://' + file_path)
                print("\033[25;140H" + " " * 40)
                print("\a")
            ...
            if int(choice) == 6:
                file_path = r"data\NWSD\final6.html"
                file_path = os.path.abspath(file_path)
                webbrowser.open('file://' + file_path)
                print("\033[25;140H" + " " * 40)
                print("\a")
            ...
            if int(choice) == 5:
                file_path = r"data\NWSD\final5.html"
                file_path = os.path.abspath(file_path)
                webbrowser.open('file://' + file_path)
                print("\033[25;140H" + " " * 40)
                print("\a")
            ...
            if int(choice) == 4:
                file_path = r"data\NWSD\final4.html"
                file_path = os.path.abspath(file_path)
                webbrowser.open('file://' + file_path)
                print("\033[25;140H" + " " * 40)
                print("\a")
            ...
            if int(choice) == 3:
                file_path = r"data\NWSD\final3.html"
                file_path = os.path.abspath(file_path)
                webbrowser.open('file://' + file_path)
                print("\033[25;140H" + " " * 40)
                print("\a")
            ...
            if int(choice) == 2:
                file_path = r"data\NWSD\final2.html"
                file_path = os.path.abspath(file_path)
                webbrowser.open('file://' + file_path)
                print("\033[25;140H" + " " * 40)
                print("\a")
            ...
            if int(choice) == 1:
                file_path = r"data\NWSD\final1.html"
                file_path = os.path.abspath(file_path)
                webbrowser.open('file://' + file_path)
                print("\033[25;140H" + " " * 40)
                print("\a")
